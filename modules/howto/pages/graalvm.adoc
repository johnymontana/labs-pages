...
[cols="1,4"]
|===
| icon:github[] Connect to Neo4j from GraalVM | https://github.com/JMHReif/neo4j-graalvm
| icon:github[] Extend Neo4j with GraalVM | https://github.com/JMHReif/neo4j-graalvm-polyglot
